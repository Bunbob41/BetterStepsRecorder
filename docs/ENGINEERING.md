...
Current state: **v0.2.4** released and in daily use by colleagues. Since
v0.1.2 the marker, LaTeX and photograph work landed, then the press-time
capture fixes (D-70, D-71), the Overleaf exports (D-75 to D-77), and 0.2.4's
finishing, editing and mark-up work (D-85 to D-92). Packaged as an
